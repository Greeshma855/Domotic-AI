...
//       <div className="w-full max-w-4xl mx-auto grid md:grid-cols-2 bg-white shadow-2xl rounded-2xl overflow-hidden">
//         {/* Contact Information Side */}
//         <div className="bg-gradient-to-br from-blue-600 to-blue-700 text-white p-12 flex flex-col justify-center">
//           <h2 className="text-4xl font-bold mb-6">Contact Us</h2>
...
//             </div>
//             <div className="flex items-center">
//               <MessageCircle className="mr-4 text-blue-200" size={24} />
//               <span>24/7 Customer Support</span>
//             </div>
//           </div>
//         </div>
